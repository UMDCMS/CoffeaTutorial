...
or equivalent. For those using putty, this is equivalent to setting up tunnel
connection with the source port set to 8XXX, and the destination set to
127.0.0.1:8XXX. After doing so you should be able to open the notebook by going
to your browser and entering the URL generated by the script ``./jupy.sh 8XXX``,
you should see some string in the format of:
...
Alternatively, you can paste the whole of the above into the browser's url bar.
